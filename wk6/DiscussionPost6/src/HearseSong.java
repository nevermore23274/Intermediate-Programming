...
public class HearseSong extends Lyrics
{
	public HearseSong(String fContent, int lCounter, int vCounter, int cCounter, int arrCharCount, char[] charArr)
	{
	...
	{
		File sLyrics = new File("HearseSong.txt"); // If you're using and IDE, will have to change this to exact file location
	...
	{
		System.out.println("The Hearse Song has " + this.lCounter + " lines of lyrics.");
		System.out.println("The Hearse Song has " + this.vCounter + " of vowels.");
		System.out.println("The Hearse Song has " + this.cCounter + " of consonant(s).");
		System.out.println("The Hearse Song has " + this.arrCharCount + " characters.");
	}
}