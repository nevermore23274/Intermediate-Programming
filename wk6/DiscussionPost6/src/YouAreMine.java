...
public class YouAreMine extends Lyrics
{
	public YouAreMine(String fContent, int lCounter, int vCounter, int cCounter, int arrCharCount, char[] charArr)
	{
	...
	{
		File sLyrics = new File("YouAreMine.txt"); // If you're using and IDE, will have to change this to exact file location
	...
	{
		System.out.println("You are Mine has " + this.lCounter + " lines of lyrics.");
		System.out.println("You are Mine has " + this.vCounter + " of vowels.");
		System.out.println("You are Mine has " + this.cCounter + " of consonant(s).");
		System.out.println("You are Mine has " + this.arrCharCount + " characters.");
	}
}